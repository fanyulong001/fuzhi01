...
<center>
    ...
    <form name="form1" method="post" action="">
        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
            ...
            <tr>
                <td colspan="5" align="right" class="td07"><img src="../../images/1.gif" width="4" height="5" align="absmiddle"> <a href="${pageContext.request.contextPath}/desktop/news/queryNewsLabel.do?pageno=1">首页</a>　 <img src="../../images/2.gif" width="3" height="5" align="absmiddle"> <a href="${pageContext.request.contextPath}/desktop/news/queryNewsLabel.do?pageno=${page.pageno-1>1 ? page.pageno-1 : 1}">上一页</a>　 <img src="../../images/2-2.gif" width="3" height="5" align="absmiddle"> <a href="${pageContext.request.contextPath}/desktop/news/queryNewsLabel.do?pageno=${page.pageno+1<page.totalPages ? page.pageno+1 : page.totalPages}">下一页</a>　 <img src="../../images/3.gif" width="4" height="5" align="absmiddle"> <a href="${pageContext.request.contextPath}/desktop/news/queryNewsLabel.do?pageno=${page.totalPages}">末页</a>　　共 ${page.totalPages} 页 ${page.totalRows} 条记录</td>
            </tr>
            <tr>
